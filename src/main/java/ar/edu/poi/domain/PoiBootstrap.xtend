...
class PoiBootstrap extends CollectionBasedBootstrap {
	...
	override run() {
		...
		jaimito = new Usuario("Jaime", "Talero")
		 ...
		 */
//Colectivos
		val colectivo78 = new ColectivoBuilder().agregarNombre("78").agregarParada(-34.570444, -58.538289).
			agregarParada(-34.578555, -58.528354).agregarParada(-34.568666, -58.542023).build

		val colectivo169 = new ColectivoBuilder().agregarNombre("169").agregarParada(-34.577999, -58.528354).
			agregarParada(-34.568755, -58.542023).build

		val colectivo343 = new ColectivoBuilder().agregarNombre("343").agregarParada(-34.579999, -58.520000).
			agregarParada(-34.687777, -58.418651).agregarParada(-34.568888, -58.542023).build

		val colectivo57 = new ColectivoBuilder().agregarNombre("57").agregarParada(-34.57999, -58.528354).
			agregarParada(-34.568666, -58.542023).build

		val colectivo328 = new ColectivoBuilder().agregarNombre("328").agregarParada(-34.579100, -58.528545).
			agregarParada(-34.568555, -58.542777).build

//Bancos
		val bancoSantander = new BancoBuilder().agregarDireccion(
			new DireccionBuilder().agregarPunto(-34.565000, -58.542023).agregarCalle("Rondeau").
				...
				agregarProvincia("Buenos Aires").agregarPais("Argentina").build).agregarHorarioBanco(
			new HorarioDeAtencionBuilder().agregarHoraInicio("10:00").agregarHoraFin("15:00").build).
			agregarNombre("Santander").agregarServicios(#["Depósitos", "Transferencias", "Cobro de cheques"]).build

		val bancoNacion = new BancoBuilder().agregarDireccion(
			new DireccionBuilder().agregarPunto(-34.575000, -58.528354).agregarCalle("Av Darko").
				agregarEntreCalle1("Los Conejos").agregarEntreCalle2("Las Alicias").agregarNumero(820).
				agregarCodigoPostal(1650).agregarLocalidad("San Martin").agregarBarrio("San Martin").
				agregarProvincia("Buenos Aires").agregarPais("Argentina").build).agregarHorarioBanco(
			new HorarioDeAtencionBuilder().agregarHoraInicio("10:00").agregarHoraFin("15:00").build).
			agregarNombre("Nacion").agregarServicios(
				#["Depósitos", "Transferencias", "Cobro de cheques", "Extracciones"]).build

		val bancoCiudad = new BancoBuilder().agregarDireccion(
			new DireccionBuilder().agregarPunto(-34.580000, -58.542023).agregarCalle("Av Los Talares").
				agregarEntreCalle1("Ebano").agregarEntreCalle2("Pino").agregarNumero(1320).agregarCodigoPostal(1650).
				agregarLocalidad("San Martin").agregarBarrio("San Martin").agregarProvincia("Buenos Aires").agregarPais(
					"Argentina").build).agregarHorarioBanco(
			new HorarioDeAtencionBuilder().agregarHoraInicio("10:00").agregarHoraFin("15:00").build).
			agregarNombre("Ciudad").agregarServicios(#["Depósitos", "Extracciones"]).build

		val bancoPiano = new BancoBuilder().agregarDireccion(
			new DireccionBuilder().agregarPunto(-34.56000, -58.528354).agregarCalle("Av Cipres").
				agregarEntreCalle1("Los Conejos").agregarEntreCalle2("Algarrobo").agregarNumero(2560).
				agregarCodigoPostal(1650).agregarLocalidad("San Martin").agregarBarrio("San Martin").
				agregarProvincia("Buenos Aires").agregarPais("Argentina").build).agregarHorarioBanco(
			new HorarioDeAtencionBuilder().agregarHoraInicio("10:00").agregarHoraFin("15:00").build).
			agregarNombre("Piano").agregarServicios(#["Transferencia", "Cobro de cheques"]).build

		val bancoRioDelPlata = new BancoBuilder().agregarDireccion(
			new DireccionBuilder().agregarPunto(-34.57000, -58.529354).agregarCalle("Av Naranjo").
				agregarEntreCalle1("Los Tomates").agregarEntreCalle2("Las Alicias").agregarNumero(2320).
				agregarCodigoPostal(1650).agregarLocalidad("San Martin").agregarBarrio("San Martin").
				agregarProvincia("Buenos Aires").agregarPais("Argentina").build).agregarHorarioBanco(
			new HorarioDeAtencionBuilder().agregarHoraInicio("10:00").agregarHoraFin("15:00").build).agregarNombre(
			"Rio Del Plata").agregarServicios(#["Prestamo", "Inversión"]).build

//Locales Comerciales
		val rubroVerduleria = new Rubro("Verduleria", 0.4)
		val rubroVivero = new Rubro("Vivero", 0.9)

		val verduleriaManolo = new LocalComercialBuilder().agregarDireccion(
			new DireccionBuilder().agregarPunto(-34.579999, -58.520000).agregarCalle("Quirno").
				...
				agregarProvincia("Buenos Aires").agregarPais("Argentina").build).agregarHorario(
			new HorarioDeAtencionBuilder().agregarHoraInicio("08:00").agregarHoraFin("17:00").build).
			agregarNombre("Don Manolo").agregarRubro(rubroVerduleria).agregarPalabrasClave(
				Arrays.asList("Maracuya", "Mango", "Melon", "Cereza")).build

		val verduleriaAmanda = new LocalComercialBuilder().agregarDireccion(
			new DireccionBuilder().agregarPunto(-34.578555, -58.530000).agregarCalle("Avellaneda").
				agregarEntreCalle1("Tannat").agregarEntreCalle2("San Pedrito").agregarNumero(100).
				agregarCodigoPostal(1650).agregarLocalidad("Flores").agregarBarrio("C.A.B.A").
				agregarProvincia("Buenos Aires").agregarPais("Argentina").build).agregarHorario(
			new HorarioDeAtencionBuilder().agregarHoraInicio("08:00").agregarHoraFin("17:00").build).agregarNombre(
			"Las Amandas").agregarRubro(rubroVerduleria).agregarPalabrasClave(
			Arrays.asList("Mango", "Anco Zapallo", "Alcaucil", "Arandano")).build

		val libreriaGarabombo = new LocalComercialBuilder().agregarDireccion(
			new DireccionBuilder().agregarPunto(-34.578555, -58.525000).agregarCalle("Amerello").
				agregarEntreCalle1("Celeste").agregarEntreCalle2("San Pedrito").agregarNumero(900).
				agregarCodigoPostal(1650).agregarLocalidad("Flores").agregarBarrio("C.A.B.A").
				agregarProvincia("Buenos Aires").agregarPais("Argentina").build).agregarHorario(
			new HorarioDeAtencionBuilder().agregarHoraInicio("08:00").agregarHoraFin("19:30").build).
			agregarNombre("Garabombo").agregarRubro(new Rubro("Libreria", 0.2)).agregarPalabrasClave(
				Arrays.asList("Libros", "Textos", "Textos Escolares", "Libros Antiguos")).build

		val viveroPalmeras = new LocalComercialBuilder().agregarDireccion(
			new DireccionBuilder().agregarPunto(-34.578555, -58.535000).agregarCalle("Marcos Sastre").
				...
				agregarProvincia("Buenos Aires").agregarPais("Argentina").build).agregarHorario(
			new HorarioDeAtencionBuilder().agregarHoraInicio("08:00").agregarHoraFin("17:00").build).agregarNombre(
			"Las Palmeras").agregarRubro(rubroVivero).agregarPalabrasClave(
			Arrays.asList("Palmera", "Platano", "Pino", "Duraznero")).build

		val viveroLotoAzul = new LocalComercialBuilder().agregarDireccion(
			new DireccionBuilder().agregarPunto(-34.578793, -58.515000).agregarCalle("Cielo Razo").
				agregarEntreCalle1("Terrada").agregarEntreCalle2("San Pedrito").agregarNumero(300).
				agregarCodigoPostal(1650).agregarLocalidad("Flores").agregarBarrio("C.A.B.A").
				agregarProvincia("Buenos Aires").agregarPais("Argentina").build).agregarHorario(
			new HorarioDeAtencionBuilder().agregarHoraInicio("08:00").agregarHoraFin("17:00").build).
			agregarNombre("LotoAzul").agregarRubro(rubroVivero).agregarPalabrasClave(
				Arrays.asList("Solanacea", "Hipomea Violacia", "Bromelia", "Orquidea")).build

//CGP
		val comuna1 = new Comuna(
			new Polygon(
				#[new Point(-34.577777, -58.528354), new Point(-34.578555, -58.528974),
					new Point(-34.599284, -58.386868), new Point(-34.579900, -58.528354)]), "CGP Comuna 1")
		val comuna2 = new Comuna(
			new Polygon(
				#[new Point(-55.569901, -88.322222), new Point(-99.576603, -18.377776),
					new Point(-34.576999, -58.528354), new Point(-38.597805, -58.475952)]), "CGP Comuna 2")
		val comuna3 = new Comuna(
			new Polygon(
				#[new Point(-34.577555, -58.528354), new Point(-34.578555, -58.528888),
					new Point(-34.599284, -108.386868), new Point(-33.597805, -76.46952)]), "CGP Comuna 3")
		val comuna4 = new Comuna(
			new Polygon(
				#[new Point(-38.569901, -48.399922), new Point(-79.579503, -158.376716),
					new Point(-34.578555, -58.528354), new Point(-34.578666, -58.528354)]), "CGP Comuna 4")
		val comuna5 = new Comuna(
			new Polygon(
				#[new Point(-34.578999, -58.528354), new Point(-34.578000, -58.528354),
					new Point(-104.599284, -199.386868), new Point(-101.597805, -106.417852)]), "CGP Comuna 5")

		val direccionComuna1 = new Direccion(new Point(-107.567801, -128.397822), "La Paz", "Bolivia", "Paraguay", 281,
			1986, "Altamirano", "Buenos Aires", "Buenos Aires", "Argentina")
		val direccionComuna2 = new Direccion(new Point(-34.577900, -58.528354), "Lavalle", "Lacroze",
			"Boulevard Ballester", 222, 1653, "Villa Ballester", "San Martin", "Buenos Aires", "Argentina")
		val direccionComuna3 = new Direccion(new Point(-34.579555, -58.528354), "Av. 5 de Mayo", "Libertador",
			"America", 2203, 1986, "Altamirano", "Buenos Aires", "Buenos Aires", "Argentina")
		val direccionComuna4 = new Direccion(new Point(-128.567901, -105.399222), "Av. Independencia", "Francia",
			"Estado de Israel", 654, 1458, "Bella Vista", "Buenos Aires", "Buenos Aires", "Argentina")
		val direccionComuna5 = new Direccion(new Point(-54.569121, -26.393232), "Av. Ricardo Balbin", "Los Ceibos",
		...
		val direccionGeneralDeLaMujer = new Servicio("Dirección Gral. de la Mujer",
...
//		RepositorioSingleton.instance.searchById(18).calificacion = calificacion12
	...
	def void agregarPoisFavoritosAUsuarios() {
		...
		/**Usuario 7*/
		/*RepositorioUsuario.instance.searchById(7) => [
		...
		*/
		/**Usuario 8*/
		/* 	RepositorioUsuario.instance.searchById(8) => [
			agregarPoiFavorito("2")
			agregarPoiFavorito("1")
			agregarPoiFavorito("13")
			agregarPoiFavorito("3")
		...
		*/
		/**Usuario 9*/
		/*RepositorioUsuario.instance.searchById(9) => [
			agregarPoiFavorito("20")
		...
		/**Usuario 10*/
		/*RepositorioUsuario.instance.searchById(10) => [
			agregarPoiFavorito("2")
		...
		*?
		/**Usuario 3 = admin*/
		/*RepositorioUsuario.instance.searchById(3) => [
			agregarPoiFavorito("2")
			agregarPoiFavorito("10")
			agregarPoiFavorito("8")
			agregarPoiFavorito("12")
